/* =============================================================================
   ...
   ========================================================================== */
(function(){
  if(window.__FB__) return; window.__FB__='2.2';
  ...
  function buttons(){
    ...
    if(ff) ff.onclick=function(){
      ...
      if(pre && pre.base){
        ...
        /* ⚠️ ใส่ "เรื่องอะไร" ลงในตัวข้อความด้วย ไม่พึ่งช่องตัวเลือกอย่างเดียว
           เจอ 2026-09-08: คำตอบ 2 อันแรกที่เข้ามาจริง ช่อง "เรื่องอะไร" ว่างทั้งคู่
           ทั้งที่ตรวจแล้วลิงก์กรอกล่วงหน้าทำงานถูกทุกจุด (entry id ตรง · ค่าตรงกับตัวเลือก
           · ไฟล์บนเว็บเป็นเวอร์ชันล่าสุด) แปลว่าคนส่งกดยกเลิกตัวเลือกเองได้ง่าย ๆ
           -> เขียนซ้ำไว้ในข้อความ จะได้ไม่หายไปไหน */
        var body='['+label(kind)+']\n'+
                 (D.getElementById('fbText').value.trim()||'')+'\n\n--- ข้อมูลประกอบ ---\n'+ctx()+
